...
//! recovery wrap is otherwise an ordinary keyeo `kek_wrap` under `WRAP_METHOD_RECOVERY_CODE_ARGON2ID` with
//! the KEK derived from the code's entropy via [`crate::derive_kek`].
