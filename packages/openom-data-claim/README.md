...
Run: `node scripts/cargo.mjs test -p openom-data-claim` (from the repo root; on Windows cargo runs under
...
use openom_data_claim::{claim_id, fingerprint, sign, verify, SigCheck};
