...
- **openom-attestations** — the signed-attestation *sidecar*: a member signs a fact's content hash, independent of the tree, riding `journal`. *(distinct from the `core/attest/v1` claim — see OPE-200.)*
