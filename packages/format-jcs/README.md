...
```rust
use format_jcs::{to_canonical_value, canonical_subset, canonical_excluding, hex256};
use serde_json::json;
...
computes an id, fingerprint, or content reference sits on top of it — directly `openom-data-model` and
