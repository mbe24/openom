...
// convergent op, and multi-device merge is real. This file replaces familyTree.js at cut-over.
//
...
export class FamilyTree {
  ...
  async #commit(deltas, { silent = false } = {}) {
  ...
  // ------------------------------------------------------------------ undo / redo (follow-up)
  // TODO(cut-over): a TreeOp inverse table (retract/unlink/re-add). Disabled until then.
